...
namespace DynamicConfiguration.Core.Redis
{
    public class RedisConnectionWrapper : IRedisConnectionWrapper
    {
        ...
        public StackExchange.Redis.IDatabase GetDatabase(int db)
        {
        ...
        public StackExchange.Redis.IServer GetServer(EndPoint endPoint)
        {
